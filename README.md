...
- Runtime i18n v2 data-driven (`locales/en.json`, `locales/fr.json`) for CLI/desktop labels (override with `RETAIA_AGENT_LANG=fr|en`), with CI key-parity validation.
