...
pub struct BatchesMovesPostRequest {
...
impl BatchesMovesPostRequest {
    pub fn new(selection: std::collections::HashMap<String, serde_json::Value>, mode: Mode) -> BatchesMovesPostRequest {
        BatchesMovesPostRequest {
            selection,
            mode,
        }
    }
