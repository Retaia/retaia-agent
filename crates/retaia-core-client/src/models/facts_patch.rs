...
pub struct FactsPatch {
    ...
    #[serde(rename = "exposure_compensation_ev", skip_serializing_if = "Option::is_none")]
    pub exposure_compensation_ev: Option<f64>,
    #[serde(rename = "color_mode", skip_serializing_if = "Option::is_none")]
    pub color_mode: Option<String>,
    #[serde(rename = "color_temperature_k", skip_serializing_if = "Option::is_none")]
    pub color_temperature_k: Option<i32>,
    #[serde(rename = "has_dji_metadata_track", skip_serializing_if = "Option::is_none")]
    pub has_dji_metadata_track: Option<bool>,
    #[serde(rename = "dji_metadata_track_types", skip_serializing_if = "Option::is_none")]
