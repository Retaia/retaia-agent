...
pub struct DecisionsPreviewPostRequest {
    #[serde(rename = "action")]
    pub action: Action,
    #[serde(rename = "filter")]
...
impl DecisionsPreviewPostRequest {
    pub fn new(action: Action, filter: std::collections::HashMap<String, serde_json::Value>, max_items: i32) -> DecisionsPreviewPostRequest {
        DecisionsPreviewPostRequest {
            action,
            filter,
            max_items,
        }
