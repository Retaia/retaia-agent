...
pub trait DerivedApi: Send + Sync {
    ...
    ///
    ///
    async fn assets_uuid_derived_get<'uuid, 'accept_language>(
        &self,
        uuid: &'uuid str,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AssetDerived, Error<AssetsUuidDerivedGetError>>;
    ...
    async fn assets_uuid_derived_kind_get<'uuid, 'kind, 'range, 'accept_language>(
        &self,
        uuid: &'uuid str,
        kind: &'kind str,
        range: Option<&'range str>,
        accept_language: Option<&'accept_language str>,
    ) -> Result<std::path::PathBuf, Error<AssetsUuidDerivedKindGetError>>;
    ...
    >(
        ...
        models::AssetsUuidDerivedUploadPartPost200Response,
