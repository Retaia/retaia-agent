...
pub trait PurgeApi: Send + Sync {
    ...
    ///
    ///
    async fn assets_purge_post<'idempotency_key, 'assets_purge_post_request, 'accept_language>(
        &self,
        idempotency_key: &'idempotency_key str,
        assets_purge_post_request: models::AssetsPurgePostRequest,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AssetsPurgePost200Response, Error<AssetsPurgePostError>>;

    /// POST /assets/{uuid}/purge
    ///
    ///
    async fn assets_uuid_purge_post<
        'uuid,
        'if_match,
        'idempotency_key,
        'assets_uuid_purge_post_request,
        'accept_language,
    >(
        &self,
        uuid: &'uuid str,
    ...
    ///
    ///
    async fn assets_uuid_purge_preview_post<'uuid, 'accept_language>(
        &self,
        uuid: &'uuid str,
        accept_language: Option<&'accept_language str>,
...
impl PurgeApi for PurgeApiClient {
    async fn assets_purge_post<'idempotency_key, 'assets_purge_post_request, 'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AssetsPurgePostError> =
