...
pub trait AssetsApi: Send + Sync {
    ...
    ///
    /// 
    async fn assets_get<'state, 'media_type, 'tags, 'has_proxy, 'tags_mode, 'q, 'location_country, 'location_city, 'geo_bbox, 'sort, 'limit, 'cursor>(&self, state: Option<models::AssetState>, media_type: Option<&'media_type str>, tags: Option<&'tags str>, has_proxy: Option<bool>, tags_mode: Option<&'tags_mode str>, q: Option<&'q str>, location_country: Option<&'location_country str>, location_city: Option<&'location_city str>, geo_bbox: Option<&'geo_bbox str>, sort: Option<&'sort str>, limit: Option<i32>, cursor: Option<&'cursor str>) -> Result<models::AssetsGet200Response, Error<AssetsGetError>>;
