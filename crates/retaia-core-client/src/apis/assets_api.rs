...
impl AssetsApi for AssetsApiClient {
    async fn assets_get<'state, 'media_type, 'tags, 'has_proxy, 'tags_mode, 'q, 'location_country, 'location_city, 'geo_bbox, 'sort, 'captured_at_from, 'captured_at_to, 'limit, 'cursor>(&self, state: Option<models::AssetState>, media_type: Option<&'media_type str>, tags: Option<&'tags str>, has_proxy: Option<bool>, tags_mode: Option<&'tags_mode str>, q: Option<&'q str>, location_country: Option<&'location_country str>, location_city: Option<&'location_city str>, geo_bbox: Option<&'geo_bbox str>, sort: Option<&'sort str>, captured_at_from: Option<String>, captured_at_to: Option<String>, limit: Option<i32>, cursor: Option<&'cursor str>) -> Result<models::AssetsGet200Response, Error<AssetsGetError>> {
        ...
        if let Some(ref param_value) = location_country {
            local_var_req_builder = local_var_req_builder.query(&[("location_country", &param_value.to_string())]);
        }
        if let Some(ref param_value) = location_city {
            local_var_req_builder = local_var_req_builder.query(&[("location_city", &param_value.to_string())]);
        }
        if let Some(ref param_value) = geo_bbox {
            local_var_req_builder = local_var_req_builder.query(&[("geo_bbox", &param_value.to_string())]);
        }
        ...
        if let Some(ref param_value) = captured_at_from {
            local_var_req_builder = local_var_req_builder.query(&[("captured_at_from", &param_value.to_string())]);
        }
        if let Some(ref param_value) = captured_at_to {
            local_var_req_builder = local_var_req_builder.query(&[("captured_at_to", &param_value.to_string())]);
        }
        if let Some(ref param_value) = limit {
            local_var_req_builder = local_var_req_builder.query(&[("limit", &param_value.to_string())]);
        }
        if let Some(ref param_value) = cursor {
            local_var_req_builder = local_var_req_builder.query(&[("cursor", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AssetsGetError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn assets_uuid_get<'uuid>(&self, uuid: &'uuid str) -> Result<(), Error<AssetsUuidGetError>> {
        ...
        let local_var_uri_str = format!("{}/assets/{uuid}", local_var_configuration.base_path, uuid=crate::apis::urlencode(uuid));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    async fn assets_uuid_patch<'uuid, 'if_match, 'assets_uuid_patch_request>(&self, uuid: &'uuid str, if_match: &'if_match str, assets_uuid_patch_request: models::AssetsUuidPatchRequest) -> Result<(), Error<AssetsUuidPatchError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AssetsUuidPatchError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn assets_uuid_reprocess_post<'uuid, 'if_match, 'idempotency_key, 'if_match2>(&self, uuid: &'uuid str, if_match: &'if_match str, idempotency_key: &'idempotency_key str, if_match2: &'if_match2 str) -> Result<(), Error<AssetsUuidReprocessPostError>> {
        ...
        let local_var_uri_str = format!("{}/assets/{uuid}/reprocess", local_var_configuration.base_path, uuid=crate::apis::urlencode(uuid));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AssetsUuidReprocessPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
