...
pub trait AuthApi: Send + Sync {
    ...
    async fn app_features_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AppFeaturesResponse, Error<AppFeaturesGetError>>;

    /// PATCH /app/features
    ///
    /// Updates effective app switches (`app_feature_enabled`). Admin-only operation. 
    async fn app_features_patch<'app_features_update_request, 'accept_language>(&self, app_features_update_request: models::AppFeaturesUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::AppFeaturesResponse, Error<AppFeaturesPatchError>>;
    ...
    async fn app_policy_get<'client_feature_flags_contract_version, 'accept_language>(&self, client_feature_flags_contract_version: Option<&'client_feature_flags_contract_version str>, accept_language: Option<&'accept_language str>) -> Result<models::AppPolicyResponse, Error<AppPolicyGetError>>;

    /// POST /app/policy
    ///
    /// Updates runtime app policy. Admin-only operation. 
    async fn app_policy_post<'app_policy_update_request, 'accept_language>(&self, app_policy_update_request: models::AppPolicyUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::AppPolicyResponse, Error<AppPolicyPostError>>;

    /// POST /auth/2fa/disable
    ///
    /// 
    async fn auth2fa_disable_post<'auth2fa_otp_request, 'accept_language>(&self, auth2fa_otp_request: models::Auth2faOtpRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<Auth2faDisablePostError>>;

    /// POST /auth/2fa/enable
    ///
    /// 
    async fn auth2fa_enable_post<'auth2fa_otp_request, 'accept_language>(&self, auth2fa_otp_request: models::Auth2faOtpRequest, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faEnableResponse, Error<Auth2faEnablePostError>>;

    /// POST /auth/2fa/recovery-codes/regenerate
    ///
    /// 
    async fn auth2fa_recovery_codes_regenerate_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faRecoveryCodesResponse, Error<Auth2faRecoveryCodesRegeneratePostError>>;
    ...
    async fn auth2fa_setup_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faSetupResponse, Error<Auth2faSetupPostError>>;
    ...
    async fn auth_clients_client_id_revoke_token_post<'client_id, 'accept_language>(&self, client_id: &'client_id str, accept_language: Option<&'accept_language str>) -> Result<models::AuthRevokeClientTokenResponse, Error<AuthClientsClientIdRevokeTokenPostError>>;
    ...
    async fn auth_clients_client_id_rotate_secret_post<'client_id, 'accept_language>(&self, client_id: &'client_id str, accept_language: Option<&'accept_language str>) -> Result<models::AuthRotateClientSecretResponse, Error<AuthClientsClientIdRotateSecretPostError>>;

    /// POST /auth/clients/device/cancel
    ///
    /// 
    async fn auth_clients_device_cancel_post<'auth_device_cancel_request, 'accept_language>(&self, auth_device_cancel_request: models::AuthDeviceCancelRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDeviceCancelResponse, Error<AuthClientsDeviceCancelPostError>>;
    ...
    async fn auth_clients_device_poll_post<'auth_device_poll_request, 'accept_language>(&self, auth_device_poll_request: models::AuthDevicePollRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDevicePollResponse, Error<AuthClientsDevicePollPostError>>;
    ...
    async fn auth_clients_device_start_post<'auth_device_start_request, 'accept_language>(&self, auth_device_start_request: models::AuthDeviceStartRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDeviceStartResponse, Error<AuthClientsDeviceStartPostError>>;

    /// POST /auth/clients/token
    ///
    /// Exchanges `(client_id, secret_key)` for an AGENT technical bearer token. 
    async fn auth_clients_token_post<'auth_client_token_request, 'accept_language>(&self, auth_client_token_request: models::AuthClientTokenRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthClientTokenSuccess, Error<AuthClientsTokenPostError>>;
    ...
    async fn auth_login_post<'auth_login_request, 'accept_language>(&self, auth_login_request: models::AuthLoginRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthLoginSuccess, Error<AuthLoginPostError>>;

    /// POST /auth/logout
    ///
    /// 
    async fn auth_logout_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthLogoutPostError>>;

    /// POST /auth/lost-password/request
    ///
    /// 
    async fn auth_lost_password_request_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthLostPasswordRequestPostError>>;

    /// POST /auth/lost-password/reset
    ///
    /// 
    async fn auth_lost_password_reset_post<'auth_lost_password_reset_request, 'accept_language>(&self, auth_lost_password_reset_request: models::AuthLostPasswordResetRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthLostPasswordResetPostError>>;
    ...
    async fn auth_me_features_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::UserFeaturesResponse, Error<AuthMeFeaturesGetError>>;
    ...
    async fn auth_me_features_patch<'user_features_update_request, 'accept_language>(&self, user_features_update_request: models::UserFeaturesUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::UserFeaturesResponse, Error<AuthMeFeaturesPatchError>>;

    /// GET /auth/me
    ///
    /// 
    async fn auth_me_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AuthCurrentUser, Error<AuthMeGetError>>;

    /// GET /auth/me/sessions
    ///
    /// 
    async fn auth_me_sessions_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AuthMeSessionsGet200Response, Error<AuthMeSessionsGetError>>;

    /// POST /auth/me/sessions/revoke-others
    ///
    /// 
    async fn auth_me_sessions_revoke_others_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AuthMeSessionsRevokeOthersPost200Response, Error<AuthMeSessionsRevokeOthersPostError>>;

    /// POST /auth/me/sessions/{session_id}/revoke
    ///
    /// 
    async fn auth_me_sessions_session_id_revoke_post<'session_id, 'accept_language>(&self, session_id: &'session_id str, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthMeSessionsSessionIdRevokePostError>>;

    /// POST /auth/refresh
    ///
    /// 
    async fn auth_refresh_post<'auth_refresh_request, 'accept_language>(&self, auth_refresh_request: models::AuthRefreshRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthLoginSuccess, Error<AuthRefreshPostError>>;
    ...
    async fn auth_verify_email_admin_confirm_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailAdminConfirmPostError>>;

    /// POST /auth/verify-email/confirm
    ///
    /// 
    async fn auth_verify_email_confirm_post<'auth_token_request, 'accept_language>(&self, auth_token_request: models::AuthTokenRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailConfirmPostError>>;

    /// POST /auth/verify-email/request
    ///
    /// 
    async fn auth_verify_email_request_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailRequestPostError>>;
}
...
impl AuthApi for AuthApiClient {
    ...
    async fn app_features_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AppFeaturesResponse, Error<AppFeaturesGetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AppFeaturesGetError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn app_features_patch<'app_features_update_request, 'accept_language>(&self, app_features_update_request: models::AppFeaturesUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::AppFeaturesResponse, Error<AppFeaturesPatchError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AppFeaturesPatchError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn app_policy_get<'client_feature_flags_contract_version, 'accept_language>(&self, client_feature_flags_contract_version: Option<&'client_feature_flags_contract_version str>, accept_language: Option<&'accept_language str>) -> Result<models::AppPolicyResponse, Error<AppPolicyGetError>> {
        ...
        if let Some(ref param_value) = client_feature_flags_contract_version {
            local_var_req_builder = local_var_req_builder.query(&[("client_feature_flags_contract_version", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AppPolicyGetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn app_policy_post<'app_policy_update_request, 'accept_language>(&self, app_policy_update_request: models::AppPolicyUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::AppPolicyResponse, Error<AppPolicyPostError>> {
        ...
        local_var_req_builder = local_var_req_builder.json(&app_policy_update_request);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AppPolicyPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth2fa_disable_post<'auth2fa_otp_request, 'accept_language>(&self, auth2fa_otp_request: models::Auth2faOtpRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<Auth2faDisablePostError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<Auth2faDisablePostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth2fa_enable_post<'auth2fa_otp_request, 'accept_language>(&self, auth2fa_otp_request: models::Auth2faOtpRequest, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faEnableResponse, Error<Auth2faEnablePostError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<Auth2faEnablePostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth2fa_recovery_codes_regenerate_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faRecoveryCodesResponse, Error<Auth2faRecoveryCodesRegeneratePostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/2fa/recovery-codes/regenerate", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<Auth2faRecoveryCodesRegeneratePostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth2fa_setup_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::Auth2faSetupResponse, Error<Auth2faSetupPostError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<Auth2faSetupPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_client_id_revoke_token_post<'client_id, 'accept_language>(&self, client_id: &'client_id str, accept_language: Option<&'accept_language str>) -> Result<models::AuthRevokeClientTokenResponse, Error<AuthClientsClientIdRevokeTokenPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/clients/{client_id}/revoke-token", local_var_configuration.base_path, client_id=crate::apis::urlencode(client_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsClientIdRevokeTokenPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_client_id_rotate_secret_post<'client_id, 'accept_language>(&self, client_id: &'client_id str, accept_language: Option<&'accept_language str>) -> Result<models::AuthRotateClientSecretResponse, Error<AuthClientsClientIdRotateSecretPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/clients/{client_id}/rotate-secret", local_var_configuration.base_path, client_id=crate::apis::urlencode(client_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsClientIdRotateSecretPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_device_cancel_post<'auth_device_cancel_request, 'accept_language>(&self, auth_device_cancel_request: models::AuthDeviceCancelRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDeviceCancelResponse, Error<AuthClientsDeviceCancelPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/clients/device/cancel", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsDeviceCancelPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_device_poll_post<'auth_device_poll_request, 'accept_language>(&self, auth_device_poll_request: models::AuthDevicePollRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDevicePollResponse, Error<AuthClientsDevicePollPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/clients/device/poll", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsDevicePollPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_device_start_post<'auth_device_start_request, 'accept_language>(&self, auth_device_start_request: models::AuthDeviceStartRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthDeviceStartResponse, Error<AuthClientsDeviceStartPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/clients/device/start", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsDeviceStartPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_clients_token_post<'auth_client_token_request, 'accept_language>(&self, auth_client_token_request: models::AuthClientTokenRequest, accept_language: Option<&'accept_language str>) -> Result<models::AuthClientTokenSuccess, Error<AuthClientsTokenPostError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthClientsTokenPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_lost_password_request_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthLostPasswordRequestPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/lost-password/request", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthLostPasswordRequestPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_lost_password_reset_post<'auth_lost_password_reset_request, 'accept_language>(&self, auth_lost_password_reset_request: models::AuthLostPasswordResetRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthLostPasswordResetPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/lost-password/reset", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn auth_me_features_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::UserFeaturesResponse, Error<AuthMeFeaturesGetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeFeaturesGetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_me_features_patch<'user_features_update_request, 'accept_language>(&self, user_features_update_request: models::UserFeaturesUpdateRequest, accept_language: Option<&'accept_language str>) -> Result<models::UserFeaturesResponse, Error<AuthMeFeaturesPatchError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeFeaturesPatchError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_me_sessions_get<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AuthMeSessionsGet200Response, Error<AuthMeSessionsGetError>> {
        ...
        let local_var_uri_str = format!("{}/auth/me/sessions", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ContentType::Json => serde_json::from_str(&local_var_content).map_err(Error::from),
                ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AuthMeSessionsGet200Response`"))),
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AuthMeSessionsGet200Response`")))),
            }
        } else {
            let local_var_entity: Option<AuthMeSessionsGetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_me_sessions_revoke_others_post<'accept_language>(&self, accept_language: Option<&'accept_language str>) -> Result<models::AuthMeSessionsRevokeOthersPost200Response, Error<AuthMeSessionsRevokeOthersPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/me/sessions/revoke-others", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ContentType::Json => serde_json::from_str(&local_var_content).map_err(Error::from),
                ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AuthMeSessionsRevokeOthersPost200Response`"))),
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AuthMeSessionsRevokeOthersPost200Response`")))),
            }
        } else {
            let local_var_entity: Option<AuthMeSessionsRevokeOthersPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_me_sessions_session_id_revoke_post<'session_id, 'accept_language>(&self, session_id: &'session_id str, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthMeSessionsSessionIdRevokePostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/me/sessions/{session_id}/revoke", local_var_configuration.base_path, session_id=crate::apis::urlencode(session_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeSessionsSessionIdRevokePostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_verify_email_admin_confirm_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailAdminConfirmPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/verify-email/admin-confirm", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthVerifyEmailAdminConfirmPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_verify_email_confirm_post<'auth_token_request, 'accept_language>(&self, auth_token_request: models::AuthTokenRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailConfirmPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/verify-email/confirm", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthVerifyEmailConfirmPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn auth_verify_email_request_post<'auth_email_request, 'accept_language>(&self, auth_email_request: models::AuthEmailRequest, accept_language: Option<&'accept_language str>) -> Result<(), Error<AuthVerifyEmailRequestPostError>> {
        ...
        let local_var_uri_str = format!("{}/auth/verify-email/request", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
/// struct for typed errors of method [`AuthApi::app_policy_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AppPolicyPostError {
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
...
/// struct for typed errors of method [`AuthApi::auth_me_sessions_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthMeSessionsGetError {
    Status401(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`AuthApi::auth_me_sessions_revoke_others_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthMeSessionsRevokeOthersPostError {
    Status401(models::ErrorResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`AuthApi::auth_me_sessions_session_id_revoke_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AuthMeSessionsSessionIdRevokePostError {
    Status401(models::ErrorResponse),
