...
pub trait AuthApi: Send + Sync {
    ...
    async fn app_features_get<'accept_language>(
        &self,
    ...
    async fn app_features_patch<'app_features_update_request, 'accept_language>(
        &self,
    ...
    async fn app_policy_get<'client_feature_flags_contract_version, 'accept_language>(
        &self,
    ...
    async fn app_policy_post<'app_policy_update_request, 'accept_language>(
        &self,
        app_policy_update_request: models::AppPolicyUpdateRequest,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AppPolicyResponse, Error<AppPolicyPostError>>;

    /// POST /auth/2fa/disable
    ///
    ///
    async fn auth2fa_disable_post<'auth2fa_otp_request, 'accept_language>(
        &self,
    ...
    ///
    ///
    async fn auth2fa_enable_post<'auth2fa_otp_request, 'accept_language>(
        &self,
        auth2fa_otp_request: models::Auth2faOtpRequest,
        accept_language: Option<&'accept_language str>,
    ...
    ///
    ///
    async fn auth2fa_recovery_codes_regenerate_post<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ...
    async fn auth2fa_setup_post<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ...
    async fn auth_clients_client_id_revoke_token_post<'client_id, 'accept_language>(
        &self,
    ...
    async fn auth_clients_client_id_rotate_secret_post<'client_id, 'accept_language>(
        &self,
        client_id: &'client_id str,
        accept_language: Option<&'accept_language str>,
    ) -> Result<
    ...
    ///
    ///
    async fn auth_clients_device_cancel_post<'auth_device_cancel_request, 'accept_language>(
        &self,
    ...
    async fn auth_clients_device_poll_post<'auth_device_poll_request, 'accept_language>(
        &self,
    ...
    async fn auth_clients_device_start_post<'auth_device_start_request, 'accept_language>(
        &self,
    ...
    async fn auth_clients_token_post<'auth_client_token_request, 'accept_language>(
        &self,
    ...
    async fn auth_login_post<'auth_login_request, 'accept_language>(
        &self,
    ...
    ///
    ///
    async fn auth_logout_post<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<(), Error<AuthLogoutPostError>>;

    /// POST /auth/lost-password/request
    ///
    ///
    async fn auth_lost_password_request_post<'auth_email_request, 'accept_language>(
        &self,
    ...
    ///
    ///
    async fn auth_lost_password_reset_post<'auth_lost_password_reset_request, 'accept_language>(
        &self,
    ...
    async fn auth_me_features_get<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ...
    async fn auth_me_features_patch<'user_features_update_request, 'accept_language>(
        &self,
    ...
    ///
    ///
    async fn auth_me_get<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AuthCurrentUser, Error<AuthMeGetError>>;

    /// GET /auth/me/sessions
    ///
    ///
    async fn auth_me_sessions_get<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AuthMeSessionsGet200Response, Error<AuthMeSessionsGetError>>;

    /// POST /auth/me/sessions/revoke-others
    ///
    ///
    async fn auth_me_sessions_revoke_others_post<'accept_language>(
        &self,
        accept_language: Option<&'accept_language str>,
    ) -> Result<
        models::AuthMeSessionsRevokeOthersPost200Response,
        Error<AuthMeSessionsRevokeOthersPostError>,
    >;

    /// POST /auth/me/sessions/{session_id}/revoke
    ///
    ///
    async fn auth_me_sessions_session_id_revoke_post<'session_id, 'accept_language>(
        &self,
        session_id: &'session_id str,
        accept_language: Option<&'accept_language str>,
    ) -> Result<(), Error<AuthMeSessionsSessionIdRevokePostError>>;

    /// POST /auth/refresh
    ///
    ///
    async fn auth_refresh_post<'auth_refresh_request, 'accept_language>(
        &self,
        auth_refresh_request: models::AuthRefreshRequest,
        accept_language: Option<&'accept_language str>,
    ) -> Result<models::AuthLoginSuccess, Error<AuthRefreshPostError>>;
    ...
    async fn auth_verify_email_admin_confirm_post<'auth_email_request, 'accept_language>(
        &self,
        auth_email_request: models::AuthEmailRequest,
        accept_language: Option<&'accept_language str>,
    ...
    ///
    ///
    async fn auth_verify_email_confirm_post<'auth_token_request, 'accept_language>(
        &self,
    ...
    ///
    ///
    async fn auth_verify_email_request_post<'auth_email_request, 'accept_language>(
        &self,
        auth_email_request: models::AuthEmailRequest,
        accept_language: Option<&'accept_language str>,
...
impl AuthApi for AuthApiClient {
    ...
    async fn app_policy_post<'app_policy_update_request, 'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AppPolicyPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn auth_me_sessions_get<'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeSessionsGetError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeSessionsRevokeOthersPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn auth_me_sessions_session_id_revoke_post<'session_id, 'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthMeSessionsSessionIdRevokePostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn auth_refresh_post<'auth_refresh_request, 'accept_language>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AuthRefreshPostError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
