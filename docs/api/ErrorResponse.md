...
**message** | **String** |  | 
**details** | Option<**std::collections::HashMap<String, serde_json::Value>**> | May include endpoint-specific structured fields such as `current_revision_etag` and `current_state` for asset state conflicts. | [optional]
**retryable** | **bool** |  | 
